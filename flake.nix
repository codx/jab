{
  ...
  inputs = {
    ...
    tree-sitter-bash = { url = "github:tree-sitter/tree-sitter-bash"; flake = false; };
    tree-sitter-python = { url = "github:tree-sitter/tree-sitter-python"; flake = false; };
    tree-sitter-hcl = { url = "github:tree-sitter-grammars/tree-sitter-hcl"; flake = false; };
  };

  outputs = { self, nixpkgs, flake-utils, zig-overlay
             , tree-sitter-bash, tree-sitter-python, tree-sitter-hcl }:
